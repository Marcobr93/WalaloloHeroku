...
mix.js('resources/assets/js/app.js', 'public/js')
    ...
    .styles(['node_modules/izimodal/css/iziModal.scss'], 'public/css/iziModal.scss')
    .styles(['resources/assets/css/spinner.scss'], 'public/css/spinner.scss')
    .styles(['resources/assets/css/app.css'], 'public/css/app.css')
    .styles(['resources/assets/css/iziModal.scss'], 'public/css/iziModal.scss')
    .styles(['resources/assets/css/walalolo.scss'], 'public/css/walalolo.scss')
